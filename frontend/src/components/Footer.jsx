...
const Footer = () => {
  ...
  return (
    <div className='text-white bg-cover bg-center w-full px-10 min-h-[350px] sm:min-h-[480px] md:min-h-[520px] lg:min-h-[580px] xl:min-h-[618px]' style={{ backgroundImage: `url(${assets.FooterBg})` }} >

      <div className='grid grid-cols-2 md:flex md:flex-row justify-evenly gap-24 py-16 px-5 text-sm'>

        {/* ----------------- Left Section --------------- */}
        <div>
          {/* Upper part */}
          <p className="text-xl font-bold mb-4 text-white whitespace-nowrap">Get In Touch With Us</p>
        ...
        {/* ----------------- Right Section --------------- */}
        <div className='flex flex-row gap-10 md:block'>
          ...
          <div className=''>
          <p className='text-xl font-bold mb-4 whitespace-nowrap md:whitespace-normal'>Follow us on social media</p>
          <hr className='mb-4 text-gray-400' />
