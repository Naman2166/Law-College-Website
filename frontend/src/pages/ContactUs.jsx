        ...
        <div className="flex flex-col lg:flex-row px-3 md:px-8 py-10 gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-1 text-sm text-gray-700">
                ...
                <p className="flex items-center gap-2">
                  <FaPhoneAlt className="text-blue-600" /> (+91) 7030082408
                </p>
              </div> 
          ...
          <div className=" pb-10 px-3">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
              {[
                { title: "Admission Cell Phone", phone: "+91-7030082408" },
                { title: "Administrative Office", phone: "+91-7030082408" },
                { title: "Principal Office", phone: "+91-7030082408" },
                { title: "Faculty Room", phone: "+91-7030082408" },
              ].map((item, index, arr) => (
                <div
                  key={index}
